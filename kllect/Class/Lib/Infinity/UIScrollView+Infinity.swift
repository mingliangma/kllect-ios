...
extension UIScrollView {
    ...
    func setContentInset(_ inset: UIEdgeInsets, completion: ((Bool) -> Void)?) {
        if self.supportSpringBounces {
            ...
            UIView.animate(withDuration: 0.4, delay: 0, usingSpringWithDamping: 0.6, initialSpringVelocity: 1.0, options: [.curveEaseInOut,.allowUserInteraction,.beginFromCurrentState], animations: { () -> Void in
            ...
            UIView.animate(withDuration: 0.3, delay: 0, options: [.curveEaseInOut,.allowUserInteraction,.beginFromCurrentState], animations: { () -> Void in
